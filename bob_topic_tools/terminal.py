...
class RosNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('title', 'Topic IO Terminal', ParameterDescriptor(
        ...
        self.declare_parameter('geometry', [0,0,1000,480], ParameterDescriptor(
            description='Window geometry. [x, y, with, height]'))
        self.declare_parameter('display', 0, ParameterDescriptor(
